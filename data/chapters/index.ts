        ...
        commandReferences: [
          {
            ...
            examples: [
              ...
              { command: 'cd ~/Documenti', description: '**~** si espande nella home dell\'utente corrente; equivale a `/home/<utente>/Documenti`.' },
            ],
          },
        ],
      },
        ...
        commandReferences: [
          {
            ...
            examples: [
              ...
              { command: 'chmod g-w config.yml', description: 'Rimuove il permesso di **scrittura** al gruppo lasciando intatti owner e others.' },
              { command: 'chmod -R 755 public/', description: 'Flag **-R** ricorsivo: owner ottiene **rwx**, group e others ottengono **r-x** su tutta la directory.' },
            ],
          },
          {
            command: 'chown',
            ...
            examples: [
              ...
              { command: 'sudo chown root:root /etc/config', description: 'Assegna la proprietà a **root** su entrambi i livelli — standard per file di sistema che non devono essere toccati da utenti normali.' },
            ],
          },
        ],
      },
        ...
        commandReferences: [
          {
            ...
            examples: [
              ...
              { command: 'sudo useradd -u 1500 -g staff -m mike', description: '**-u** forza un UID specifico, **-g** imposta `staff` come gruppo primario.' },
            ],
          },
          {
            command: 'usermod',
            ...
            examples: [
              ...
              { command: 'sudo usermod -l nuovonome mike', description: '**-l** rinomina il login in `nuovonome`; la home directory non viene rinominata automaticamente.' },
              { command: 'sudo usermod -L mike', description: '**-L** (lock) disabilita il login con password senza cancellare l\'account.' },
            ],
          },
          {
            command: 'userdel',
    ...
    projectLab: {
      ...
      steps: [
        ...
        },
        {
          ...
          context: [
            '**-m** crea la **home directory** (`/home/giulia` ecc.): senza, l\'utente esiste nel sistema ma non ha cartella personale.',
            '**-s /bin/bash** imposta **bash** come shell di login — senza, la distro potrebbe assegnare `/bin/sh` o nessuna shell interattiva.',
            '**-G ops** assegna **ops** come **gruppo supplementare**: il gruppo primario dell\'utente resta quello omonimo (`giulia`, `antonio`).',
          ],
          command: {
